...
ggsave("plot1.png", width=20, units="in")
...
plot2 <- ggplot(gapminder_without_Kuwait, aes(x=year, y= gdpPercap, size=pop/100000))+
  ...
  theme_bw()+
  labs(x="Wealth and population distribution through time",y="GDP per capita", size="Population (100k)")
...
ggsave("plot2.png", width=20, units="in")
